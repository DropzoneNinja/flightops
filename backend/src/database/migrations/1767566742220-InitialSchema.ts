...
export class InitialSchema1767566742220 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "weather_hourly" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "forecast_id" uuid NOT NULL, "timestamp" TIMESTAMP NOT NULL, "temperature" numeric(5,2) NOT NULL, "wind_speed" numeric(5,2) NOT NULL, "gust_speed" numeric(5,2) NOT NULL, "gust_spread" numeric(5,2) NOT NULL, "rain" numeric(5,2) NOT NULL DEFAULT '0', "wind_score" integer NOT NULL, "gust_score" integer NOT NULL, "rain_score" integer NOT NULL, "overall_score" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_fcc1519cd229839013dc358d49a" UNIQUE ("forecast_id", "timestamp"), CONSTRAINT "PK_97f237384d1f399375909a9db8c" PRIMARY KEY ("id"))`);
