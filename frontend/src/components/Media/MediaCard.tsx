  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {user?.is_admin && (
          <div className="mt-2 pt-2 border-t border-sky-midday">
            <div className="flex items-center justify-between text-xs text-sky-dusk">
              <div className="flex items-center gap-1" aria-label={`${media.view_count} views`}>
                <svg
              ...
              <div className="flex items-center gap-1" aria-label={`${media.download_count} downloads`}>
                <svg
                  className="w-3.5 h-3.5"
                  fill="none"
                  strokeWidth={2}
