...
import {
  EquipmentEngine, EquipmentWing, EquipmentParamotor,
  CreateEngineData, CreateWingData, CreateParamotorData,
...
type Tab = 'paramotors' | 'engines' | 'wings';
...
export default function EquipmentPage() {
  ...
  const isLoading = enginesLoading || wingsLoading || paramotorsLoading;
  ...
  return (
    <div className="flex h-screen bg-[#0d1421] overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
          ...
          <div className="px-6 pt-6 pb-4 border-b border-[#1e2a3a] flex-shrink-0">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-[#6b7fa3] mt-0.5">Manage your paramotors, engines, and wings</p>
              </div>
              <button
                onClick={() => {
              ...
              >
                ...
                Add {activeTab === 'engines' ? 'Engine' : activeTab === 'wings' ? 'Wing' : 'Paramotor'}
              </button>
            </div>
        ...
        {/* Side panel */}
        {panel && (
          <div className="w-80 border-l border-[#1e2a3a] bg-[#111827] flex flex-col overflow-hidden flex-shrink-0">
