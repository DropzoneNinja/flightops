        ...
        <header className="border-b border-[#1e2a3a] shrink-0 sticky top-0 z-10" style={{ background: '#0d1421' }}>
          <div className="px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-sm font-semibold text-white">Search Results</h1>
                {filterSummary && <p className="text-xs text-[#6b7fa3]">{filterSummary}</p>}
              </div>
            </div>
        ...
        <main className="flex-1 overflow-y-auto px-6 py-8">
          {!hasFilters ? (
            <div className="bg-[#141d2e] rounded-xl border border-[#1e2a3a] p-8 text-center">
              <p className="text-[#6b7fa3] mb-4">No filters specified.</p>
              <button
                onClick={() => navigate('/media')}
                className="px-5 py-2.5 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors"
              >
            ...
            <div className="bg-[#141d2e] rounded-xl border border-[#1e2a3a] p-8 text-center py-16">
              ...
              <h3 className="text-base font-semibold text-white mb-2">No media found</h3>
              <p className="text-[#6b7fa3] text-sm mb-5">No media matches the selected filters.</p>
              <button
                onClick={() => navigate('/media')}
                className="px-5 py-2.5 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors"
              >
